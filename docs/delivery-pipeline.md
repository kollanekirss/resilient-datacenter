...
| 3 | Recovery readiness report | Implemented read-only evidence assessment; acceptance pending | Missing material, actual backup age, certificate coverage for the planned offline period, usable recovery credentials and last successful exercise |
