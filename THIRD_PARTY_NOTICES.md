...
| Nextcloud Server | 35.0.1 | [Source and included licences](https://github.com/nextcloud/server/tree/v35.0.1); AGPL, with individual files retaining their stated version and dependency licences. The container packaging is maintained in [nextcloud/docker](https://github.com/nextcloud/docker). |
